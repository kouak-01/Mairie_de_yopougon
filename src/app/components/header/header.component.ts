...
export class HeaderComponent {
  ...
  readonly navItems: NavItem[] = [
    ...
    { id: 'services-en-ligne', label: 'Services en ligne', externalLink: 'https://guichet.yopougon.ci/#/connexion' },
    {
      ...
      children: [
        { id: 'radio-info', label: 'Informations générales', icon: 'fa-circle-info', link: '/radio' },
        { id: 'radio-programme', label: 'Programme de la radio', icon: 'fa-list', link: '/radio/programme' },
        { id: 'radio-vacances', label: 'Spécial vacances', icon: 'fa-umbrella-beach', link: '/radio/special-vacances' },
        { id: 'radio-facebook', label: 'Facebook', icon: 'fa-facebook', iconType: 'fab', externalLink: 'https://web.facebook.com/Mairieyop' },
      ],
    },
    {
      id: 'yop-ma-commune',
    ...
    },
    {
      ...
      label: 'Contacts',
      children: [
        { id: 'coordonnees', label: "Coordonnées et plans d'accès", icon: 'fa-map-marker-alt', link: '/contact' },
        { id: 'formulaire', label: 'Formulaire de contact', icon: 'fa-envelope-open-text', link: '/contact/formulaire' },
        { id: 'reseaux', label: 'Réseaux sociaux', icon: 'fa-share-nodes', link: '/contact/reseaux-sociaux' },
        { id: 'faq', label: 'FAQ', icon: 'fa-circle-question', link: '/contact/faq' },
      ],
    },
