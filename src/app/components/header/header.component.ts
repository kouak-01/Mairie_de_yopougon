  ...
  readonly navItems: NavItem[] = [
    {
      ...
      children: [
        ...
        },
        {
          ...
          icon: 'fa-sitemap',
          children: [
            { id: 'secretariat-general', label: 'Secrétariat Général', link: '/en-construction' },
            { id: 'municipalite', label: 'La Municipalité', link: '/en-construction' },
            { id: 'conseil-municipal', label: 'Le Conseil Municipal', link: '/en-construction' },
            { id: 'commissions', label: 'Commissions du Conseil Municipal', link: '/en-construction' },
            { id: 'directions', label: 'Directions Techniques et Administratives', link: '/en-construction' },
          ],
        },
        {
          ...
          icon: 'fa-newspaper',
          children: [
            { id: 'actualites', label: 'Actualités', link: '/', fragment: 'actualites' },
            { id: 'videotheque', label: 'Vidéothèque', link: '/en-construction' },
            { id: 'opportunites', label: "Opportunités d'affaires", link: '/en-construction' },
            { id: 'agenda', label: 'Agenda', link: '/en-construction' },
          ],
        },
        { id: 'nos-projets', label: 'Nos Projets', icon: 'fa-diagram-project', link: '/en-construction' },
      ],
    },
    ...
    },
    {
      ...
      children: [
        { id: 'histoire', label: 'Histoire', icon: 'fa-scroll', link: '/yop-ma-commune', fragment: 'histoire' },
        { id: 'histoire-politique', label: 'Histoire politique', icon: 'fa-landmark', link: '/yop-ma-commune', fragment: 'histoire-politique' },
        { id: 'geographie', label: 'Géographie', icon: 'fa-map', link: '/yop-ma-commune', fragment: 'geographie' },
        { id: 'gouvernance', label: 'Gouvernance participative', icon: 'fa-people-group', link: '/yop-ma-commune', fragment: 'gouvernance-participative' },
        { id: 'economie', label: 'Économie', icon: 'fa-chart-line', link: '/yop-ma-commune', fragment: 'economie' },
        { id: 'emplois', label: 'Emplois', icon: 'fa-briefcase', link: '/yop-ma-commune', fragment: 'emplois' },
        { id: 'sport-culture', label: 'Sport et culture', icon: 'fa-futbol', link: '/yop-ma-commune', fragment: 'sport-culture' },
        { id: 'tourisme', label: 'Tourisme et loisirs', icon: 'fa-umbrella-beach', link: '/yop-ma-commune', fragment: 'tourisme-loisirs' },
      ],
    },
    {
      id: 'contacts',
